...
let ScrollView = _decorate([customElement('rmini-scroll-view')], function (_initialize, _LitElement) {
  class ScrollView extends _LitElement {
    constructor(...args) {
      super(...args);
  ...
  return {
    ...
    d: [{
      ...
      decorators: [property({
        type: Boolean,
        attribute: 'enable-back-to-top'
      })],
      key: "_enableBackToTop",
      ...
      decorators: [property({
        type: String,
        attribute: 'bindscrolltoupper'
      })],
      key: "_bindscrolltoupper",
      ...
      decorators: [property({
        type: String,
        attribute: 'bindscrolltolower'
      })],
      key: "_bindscrolltolower",
    ...
    `;
      ...
      value: function onScrollHandler(e) {
        window.__vm.triggerEvent('scroll', this._bindscroll, e); // TODO: 其他方法
      ...
      value: function connectedCallback() {
        _get(_getPrototypeOf(ScrollView.prototype), "connectedCallback", this).call(this);
      ...
      value: function disconnectedCallback() {
        _get(_getPrototypeOf(ScrollView.prototype), "disconnectedCallback", this).call(this);
...
let ScrollView$1 = _decorate([customElement('rmini-view')], function (_initialize, _LitElement) {
  class ScrollView extends _LitElement {
    constructor(...args) {
      super(...args);
...
let ScrollView$2 = _decorate([customElement('rmini-text')], function (_initialize, _LitElement) {
  class ScrollView extends _LitElement {
    constructor(...args) {
      super(...args);
...
let ScrollView$3 = _decorate([customElement('rmini-input')], function (_initialize, _LitElement) {
  class ScrollView extends _LitElement {
    constructor(...args) {
      super(...args);
  ...
  return {
    ...
    d: [{
      ...
      value: function update(changedProperties) {
        _get(_getPrototypeOf(ScrollView.prototype), "update", this).call(this, changedProperties);
